...
# echo '/etc/init.d/memcached' &gt;&gt; /etc/rc.local</pre>
    ...
    <ol>
        ...
        <li>
        	...
        	<pre class="console"># cp /var/www/vhosts/domain.com/httpdocs/wp-content/plugins/a2-w3-total-cache/ini/memcache.ini /etc/php.d/</pre>
        </li>
        <li>
...
# whereis apxs</pre>
        ...
        <li>
			...
			<pre class="console"># cp /var/www/vhosts/domain.com/httpdocs/wp-content/plugins/a2-w3-total-cache/ini/apc.ini /etc/php.d/</pre>
		</li>
		<li>
    ...
    <ol>
        ...
        <li>
			...
			<pre class="console"># cp /var/www/vhosts/domain.com/httpdocs/wp-content/plugins/a2-w3-total-cache/ini/xcache.ini /etc/php.d/</pre>
		</li>
		<li>
			<?php _e('Restart apache when ready:', 'w3-total-cache'); ?>
			<pre class="console"># /etc/init.d/httpd restart</pre>
    ...
    <ol>
        ...
        <li>
        	<?php _e('You can also use the eaccelerator.ini file we prepared for you:', 'w3-total-cache'); ?>
			<pre class="console"># cp /var/www/vhosts/domain.com/httpdocs/wp-content/plugins/a2-w3-total-cache/ini/eaccelerator.ini /etc/php.d/</pre>
		</li>
		<li>
			<?php _e('Restart apache when ready:', 'w3-total-cache'); ?>
			<pre class="console"># /etc/init.d/httpd restart</pre>
